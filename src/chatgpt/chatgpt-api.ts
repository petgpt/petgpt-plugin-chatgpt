...
import {MessageStore} from "./types.js";
...
export class ChatGPTAPI {
    ...
    constructor(opts: types.ChatGPTAPIOptions) {
        ...
        // 这里设置了默认的completionParams，包括默认的model、temperature、top_p、presence_penalty
        this._completionParams = {
            model: CHATGPT_MODEL,
            temperature: 0.8,
            top_p: 1.0,
            presence_penalty: 1.0,
            ...completionParams// 这里如果传入了completionParams，会覆盖上面的默认param
        }
        ...
        const responseP = new Promise<types.ChatMessage>(
            async (resolve, reject) => {
                ...
                const body = {
                    ...
                    ...this._completionParams,
                    ...completionParams, // 如果存在相同的name，下面的completionParams会覆盖上面的默认值
                    messages,
                    stream
                }
                ...
                if (stream) {
                    ...
                    try {
                        ...
                        if (!res.ok) {
                            ...
                            const error = new types.ChatGPTError(`msg: ${msg}, cause: ${res}`)
